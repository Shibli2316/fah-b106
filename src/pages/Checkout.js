                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list">
                                        {addresses.map((address) => (
                                            <li key={address.email} className="flex justify-between gap-x-6 py-5 border-solid border-2 border-grey-200 px-5">
                                                ...
                                                <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                                    ...
                                                    <p className="text-sm leading-6 text-gray-600">{address.pinCode}</p>
                                                </div>
